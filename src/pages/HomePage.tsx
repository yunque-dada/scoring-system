...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold">欢迎回来！</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {statCards.map((card, index) => {
          ...
          return (
            ...
            >
              <div className={`w-12 sm:w-14 h-12 sm:h-14 rounded-2xl bg-gradient-to-br ${card.color} flex items-center justify-center mb-4 sm:mb-6`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900">学生组别分布</h3>
        ...
        <div className="card p-4 sm:p-6">
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900">快速操作</h3>
            ...
            {quickActions.map((action, index) => {
              ...
              return (
                <Link 
                  key={action.title} 
                  to={action.path}
                  className="group flex items-center justify-between p-3 sm:p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-300 border border-gray-100 hover:border-gray-200"
                >
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className={`w-10 sm:w-12 h-10 sm:h-12 rounded-xl bg-gradient-to-br ${action.color} flex items-center justify-center`}>
                      <Icon className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
                    </div>
                    <span className="font-semibold text-gray-900">{action.title}</span>
                  </div>
                  <ArrowRight className="w-4 sm:w-5 h-4 sm:h-5 text-gray-400 group-hover:text-gray-600 group-hover:translate-x-1 transition-all" />
                </Link>
              );
            })}
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="card p-4 sm:p-6">
          <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-500 flex items-center justify-center mb-4 sm:mb-6">
            <Layers className="w-6 sm:w-7 h-6 sm:h-7 text-white" />
          </div>
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">多组别管理</h3>
          <p className="text-gray-600">轻松创建和管理不同的比赛组别，满足各种比赛需求</p>
        </div>
        <div className="card p-4 sm:p-6">
          <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mb-4 sm:mb-6">
            <Users className="w-6 sm:w-7 h-6 sm:h-7 text-white" />
          </div>
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">学生信息维护</h3>
          <p className="text-gray-600">完整的学生信息管理系统，支持添加、编辑和删除学生</p>
        </div>
        <div className="card p-4 sm:p-6">
          <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center mb-4 sm:mb-6">
            <Trophy className="w-6 sm:w-7 h-6 sm:h-7 text-white" />
          </div>
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">实时记分排行</h3>
